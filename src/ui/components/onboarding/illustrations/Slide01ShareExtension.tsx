...
// Timing constants
const TIMING = {
  SCENE_1: 1000,  // Initial state
  SCENE_2: 300,   // Share button press
  SCENE_3: 400,   // Share sheet slides up
  SCENE_4: 300,   // PageKeep icon press
  SCENE_5: 800,   // Saved modal visible
  SCENE_6: 400,   // Modal dismisses
  PAUSE: 500,     // Pause before loop
};
...
const Slide01ShareExtension: React.FC<Slide01Props> = ({ colors }) => {
  ...
  const runAnimation = () => {
    ...
    // Scene 2: Share button press (at 1000ms)
    shareButtonScale.value = withDelay(
      TIMING.SCENE_1,
      withSequence(
        withTiming(0.85, { duration: 150, easing: Easing.out(Easing.cubic) }),
        withTiming(1, { duration: 150, easing: Easing.out(Easing.cubic) })
      )
    );

    // Scene 3: Share sheet slides up (at 1300ms)
    const scene3Start = TIMING.SCENE_1 + TIMING.SCENE_2;
    ...
    // Scene 4: PageKeep icon press (at 1700ms)
    ...
    // Scene 5: Saved modal appears (at 2000ms)
    ...
    // Scene 6: Modal dismisses (at 2800ms)
    ...
    shareSheetOpacity.value = withDelay(
      scene6Start + TIMING.SCENE_6 - 100,
  ...
  return (
    <Svg width="300" height="220" viewBox="0 0 300 220">
      ...
      <G clipPath="url(#screenClip)">
        ...
        {/* Share button (center of toolbar) */}
        <AnimatedG
